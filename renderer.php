 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_choicegnrquiz_renderer_base extends qtype_with_combined_feedback_renderer {
     ...
     * options returned by {@link qtype_choicegnrquiz:;get_numbering_styles()}.
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_choicegnrquiz_single_renderer extends qtype_choicegnrquiz_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectone', 'qtype_choicegnrquiz');
    }
    ...
    public function correct_response(question_attempt $qa) {
        ...
        foreach ($question->answers as $ansid => $ans) {
            if (question_state::graded_state_for_fraction($ans->fraction) ==
                ...
                return get_string('correctansweris', 'qtype_choicegnrquiz',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_choicegnrquiz_multi_renderer extends qtype_choicegnrquiz_renderer_base {
    protected function get_input_type() {
        return 'checkbox';
    }
    ...
    protected function prompt() {
        return get_string('selectmulti', 'qtype_choicegnrquiz');
    }
    ...
    protected function num_parts_correct(question_attempt $qa) {
        if ($qa->get_question()->get_num_selected_choices($qa->get_last_qt_data()) >
            ...
            return get_string('toomanyselected', 'qtype_choicegnrquiz');
        }
