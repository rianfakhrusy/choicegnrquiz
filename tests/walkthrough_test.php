 ...
 *
 * Note, there are already lots of tests of the choicegnrquiz type in the behaviour
 * tests. (Search for test_question_maker::make_a_choicegnrquiz.) This file only
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_choicegnrquiz_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_deferredfeedback_feedback_choicegnrquiz_single() {

        // Create a choicegnrquiz, single question.
        $mc = test_question_maker::make_a_choicegnrquiz_single_question();
    ...
    public function test_deferredfeedback_feedback_choicegnrquiz_multi() {
        // Create a choicegnrquiz, multi question.
        $mc = test_question_maker::make_a_choicegnrquiz_multi_question();
        $mc->shuffleanswers = false;
