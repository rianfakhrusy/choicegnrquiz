...
require_once($CFG->dirroot . '/question/type/choicegnrquiz/questiontype.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/choicegnrquiz/edit_choicegnrquiz_form.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_choicegnrquiz_test extends advanced_testcase {
    protected $qtype;

    protected function setUp() {
        $this->qtype = new qtype_choicegnrquiz();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'choicegnrquiz');
    }
    ...
    public function test_question_saving_two_of_four($which) {
        ...
        $questiondata = test_question_maker::get_question_data('choicegnrquiz', $which);
        $formdata = test_question_maker::get_question_form_data('choicegnrquiz', $which);

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_choicegnrquiz_edit_form::mock_submit((array)$formdata);

        $form = qtype_choicegnrquiz_test_helper::get_question_editing_form($cat, $questiondata);
