...
Feature: Test editing a Multiple choice question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | choicegnrquiz | Multiple choice for editing | two_of_four |
      | Test questions   | choicegnrquiz | Single choice for editing   | one_of_four |
