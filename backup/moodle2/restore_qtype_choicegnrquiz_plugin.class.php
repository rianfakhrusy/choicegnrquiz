 ...
 * needed to restore one choicegnrquiz qtype plugin
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_choicegnrquiz_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff.
        $elename = 'choicegnrquiz';
        // We used get_recommended_name() so this works.
        $elepath = $this->get_pathfor('/choicegnrquiz');
    ...
    /**
     * Process the qtype/choicegnrquiz element
     */
    public function process_choicegnrquiz($data) {
        global $DB;
        ...
        // qtype_choicegnrquiz_options too.
        if ($questioncreated) {
            $data->questionid = $newquestionid;

            // It is possible for old backup files to contain unique key violations.
            // We need to check to avoid that.
            if (!$DB->record_exists('qtype_choicegnrquiz_options', array('questionid' => $data->questionid))) {
                $newitemid = $DB->insert_record('qtype_choicegnrquiz_options', $data);
                $this->set_mapping('qtype_choicegnrquiz_options', $oldid, $newitemid);
            }
        }
    }
     ...
     * recoded pointing to all the restored stuff for choicegnrquiz questions
     *
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('qtype_choicegnrquiz_options',
                $fields, 'qtype_choicegnrquiz_options');
